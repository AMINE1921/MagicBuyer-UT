...
let setupDone = false;
let searchFiltersViewInit;
let searchFiltersAppear;

export const AutoBuyerViewController = function () {
  const Parent = getMarketSearchFiltersViewController();
  if (!Parent) {
    throw new Error("UTMarketSearchFiltersViewController introuvable");
  }
  Parent.call(this);
};
...
export const setupAutoBuyerViewController = () => {
  if (setupDone) {
    return true;
  }
  ...
  searchFiltersViewInit = Parent.prototype.init;
  searchFiltersAppear = Parent.prototype.viewDidAppear;
  inherits(AutoBuyerViewController, Parent);
  ...
  Parent.prototype.viewDidAppear = function () {
